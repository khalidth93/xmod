...
# doc/isoclinic.xml:208-212
gap> DXn4 := DerivedSubXMod( Xn4 );;
gap> IdGroup( DXn4 );
[ [ 3, 1 ], [ 3, 1 ] ]

# doc/isoclinic.xml:233-239
...
# doc/isoclinic.xml:298-302
gap> Q24 := CentralQuotient( d24);  IdGroup( Q24 );                     
[d24->d24/Z(d24)]
[ [ 24, 6 ], [ 12, 4 ] ]

# doc/isoclinic.xml:326-336
...
gap> names := [ "(C2 x D8) : C2", "C8 : (C2 x C2)" ];;
gap> StructureDescription( K ) in names;
true
...
[ [ 16, 5 ], [ 2, 1 ] ]
gap> AreIsoclinicDomains( X82, X9 );
true
gap> ism829 := Isoclinism( X82, X9 );;
gap> Display( ism829 );
