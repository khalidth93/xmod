...
gap> YAq8 := Image( iso );;
gap> NrMovedPoints( YAq8 );
[ 8, 6 ]
gap> ## change the degree of the range
...
gap> NrMovedPoints( Image( mor ) );
[ 8, 4 ]

# doc/gp2map.xml:288-308
...
# doc/gp2map.xml:372-375
gap> iso8 := IsomorphismPerm2DimensionalGroup( C8 );
[[G8=>d12] => [..]]

# doc/gp2map.xml:388-400
...
# doc/gp2map.xml:584-587
gap> SubQuasiIsomorphism( C18a, false );
[ [ 2, 1, 1 ], [ 2, 1, 1 ], [ 2, 1, 1 ] ]

# doc/gp2map.xml:597-600
